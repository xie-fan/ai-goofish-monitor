const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      keywordRulesHint: 'One group per line. Lines use OR; keywords inside a group can be split by English or Chinese commas and all must match. Alphanumeric keywords match whole words.',
      keywordRulesPlaceholder: 'Example: a7m4, Verified Authentic\nsony, Full Frame\nPersonal Listing',
